...
public class NoticeActivity4 extends AppCompatActivity {
    ...
    private Button btn_post_4, btnpost4; //게시글 작성 버튼
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnpost4 = findViewById(R.id.btnpost4);
        btnpost4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(NoticeActivity4.this, FoodCategory.class);
                startActivity(intent);
            }
        });
    }
